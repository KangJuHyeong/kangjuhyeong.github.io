...
- 소개, 연락처, 핵심 기술, 학력 및 이력, Campuslink와 Reserva 프로젝트를 한 페이지에 제공한다.
...
3. 학력 및 이력: 학력, 개발 교육, 자격, 어학, 병역을 두 열로 제공한다.
4. Campuslink: 서비스 목적, 기술 태그, 핵심 구현 두 개, 저장소 링크.
5. Reserva: 서비스 목적, 기술 태그, 동시 예약 정합성 구현, 저장소 링크.
6. 하단: GitHub 프로필 링크와 포트폴리오 안내 문구.
